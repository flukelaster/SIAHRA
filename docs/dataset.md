...
138,057 เซลล์ ท่วม 3,197 เซลล์ = 85,087 B — ไบต์แปรตามเซลล์ที่สังเกตได้ ไม่ใช่จำนวน frame)
ตอนนี้มีแต่ฉาก live สะสมเข้ามา (backfill อัตโนมัติถูกถอดออก 2026-09-21) ประมาณการค่าใช้จ่ายอยู่ใน `docs/deploy.md`
