...
| `flood/gfm/backfill-state.json` | **ไม่มีใครเขียนแล้ว** — cursor ของ backfill อัตโนมัติ (E14.F6) ที่ถูกถอดออก 2026-09-21; อ็อบเจกต์ที่ค้างอยู่บน R2 ไม่มีผลกับอะไรอีก ลบทิ้งได้ | ไม่เสิร์ฟให้เบราว์เซอร์ — prefix `flood/gfm/` ไม่มี route ใน Worker |
