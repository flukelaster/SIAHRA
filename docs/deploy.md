...
| จังหวัด | สถานะใน state | ฉากใน `index.json` | `index.json` (ไบต์ที่เสิร์ฟ) | ฉากเก่าสุด |
|---|---|---|---|---|
| 10, 11 | done | 735 / 732 | 467 KB / 464 KB | 2015-01-09 |
| 12 | done | 735 | 373 KB | 2015-01-09 |
| 13, 14 | done | 735 / 735 | 717 KB / 717 KB | 2015-01-09 |
| 15, 17 | done | 735 / 734 | 393 KB / 392 KB | 2015-01-09 |
| 18 | done | 985 | 526 KB | 2015-01-09 |
| 16 | **failed** (index ล้น) | 1,130 | 686 KB | 2019-04-10 |
| 19 | **failed** (index ล้น) | 945 | 574 KB | 2020-03-17 |
| 20 | **failed** (index ล้น) | 874 | 504 KB | 2020-08-09 |
| 21 | ค้างกลางทาง (`current`) | 1,340 | 675 KB | 2017-12-23 |
...
⚠️ **ข้อเสียที่ค้างอยู่กับผู้ใช้จริง**: `index.json` ของ 12 จังหวัดนี้อยู่ที่ 373–717 KB ทุกใบ เทียบกับ
จังหวัดที่ไม่โดน backfill ราว 7 KB (เช่น 57) และเว็บโหลดไฟล์นี้ทุกครั้งที่เปิดจังหวัด (`max-age=300`)
เกณฑ์รับงานของ E14.F6 ที่เขียนไว้ว่า "ทุกจังหวัด index ต่ำกว่า ~300 KB" จึง **ไม่ผ่าน**ทั้ง 12 จังหวัด
การถอด Phase 2 หยุดไม่ให้โตต่อ แต่ไม่ได้แก้ของที่ลงไปแล้ว — ทางเลือกคือปล่อยไว้, แยก index เป็น
recent/archive ตาม follow-up ของ F6, หรือลบฉาก backfill ของ 12 จังหวัดนี้ทิ้งให้เท่าจังหวัดอื่น
(ยังไม่ได้ตัดสินใจ ณ 2026-09-21)
