"""ฉากจริงของเชียงราย (57) 2024-09-13T11:22:41Z — ผลิตจาก STAC/COG จริงเมื่อ 2026-09-02 (E14.F2 ข้อ 8)
...
def test_golden_meta_matches_decoded_field():
    ...
    assert meta["sceneId"] == SCENE and meta["observedAt"] == "2024-09-13T11:22:41Z"
