...
export const en: Record<keyof typeof th, string> = {
  ...
  "legend.layer.water.note": "3D water surfaces laid on the terrain",
  "legend.layer.roads": "Main roads (OSM)",
  "legend.layer.roads.note": "Motorways / highways / secondary roads",
  ...
  "legend.layer.buildings.note": "Whole province · only large/tall buildings from far away",
