...
export const th = {
  ...
  "legend.layer.water.note": "ผิวน้ำ 3 มิติ วางตามระดับภูมิประเทศ",
  "legend.layer.roads": "ถนนสายหลัก (OSM)",
  "legend.layer.roads.note": "มอเตอร์เวย์ / ทางหลวง / ถนนสายรอง",
  ...
  "legend.layer.buildings.note": "ทั้งจังหวัด · มองไกลแสดงเฉพาะอาคารใหญ่/สูง",
