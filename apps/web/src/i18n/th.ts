...
export const th = {
  ...
  "lang.loadFailed": "โหลดภาษาอังกฤษไม่สำเร็จ — โหลดหน้าใหม่แล้วลองอีกครั้ง",
  ...
  "common.chunkFailed": "โหลดส่วนนี้ไม่สำเร็จ —",
  "common.renderFailed": "ส่วนนี้แสดงผลไม่สำเร็จ —",
  ...
  /** E16 B-2 — แผ่นน้ำ 3 มิติบนขอบเขต GISTDA (ขอบเขตตรวจวัดจริง · ความลึกภาพประกอบ) */
  "legend.layer.gistdaDepth": "แผ่นน้ำ 3 มิติจาก GISTDA",
  ...
  "legend.gistdaDepth.method":
    "วิธี: ระดับผิวน้ำ = ความสูงพื้นที่ขอบน้ำ (มัธยฐาน 3×3) แผ่ไปยังเซลล์ท่วมที่ใกล้ที่สุด · ความลึก = ผิวน้ำ − พื้น (0–10 ม.) · ข้อสมมติ: GISTDA ส่งมาเฉพาะเซลล์ที่ท่วม จึงถือว่าทุกเซลล์ในจังหวัดที่ไม่ท่วมเป็น 'แห้ง' เพื่อหาขอบน้ำ — ไม่ใช่สิ่งที่ดาวเทียมบอก · ความสูงพื้นเป็น DSM (รวมหลังคา/ยอดไม้) และเป็นจำนวนเต็มเมตร · ไม่ได้ตัดอาคาร/ต้นไม้ออก เพราะข้อมูลสิ่งปกคลุมดินมีเฉพาะไทล์ 30 ม. ไม่มีบนกริดนี้ · ไม่ได้วัดจริง ไม่ใช่การพยากรณ์",
  "legend.gistdaDepth.summary": "{n} เซลล์ท่วมบนกริด ~{m} ม. · ลึกสุดราว {max} ม. (ภาพประกอบ)",
  "legend.gistdaDepth.noBoundary":
    "ไม่มีขอบน้ำให้อ้างอิง — {n} เซลล์ท่วมแต่ไม่ได้ประมาณความลึก (ไม่ใช่ 0 ม.) จึงไม่ยกเป็นแผ่น",
  "legend.gistdaDepth.notEst": "{n} เซลล์ท่วมที่ไม่ได้ประมาณความลึก — ไม่ยกเป็นแผ่น (ยังเป็นสีบนพื้น)",
  "legend.gistdaDepth.tooSmall": "เซลล์ GISTDA เล็กกว่ากริด ~{m} ม. จนไม่ตกเซลล์ใด — ยังเป็นสีบนพื้น",
  "legend.gistdaDepth.gfmFirst": "{n} เซลล์ใช้ภาพ Sentinel-1 (GFM) ที่แสดงอยู่แทน (มีเวลาถ่ายภาพต่อรอบ)",
  "legend.gistdaDepth.pending": "กำลังคำนวณความลึก…",
  "legend.gistdaDepth.error": "คำนวณความลึกไม่สำเร็จ ({error}) — ขอบเขตยังแสดงเป็นสีบนพื้น",
  "legend.gistdaDepth.needsExtent": "มีผลเมื่อเปิดชั้นน้ำท่วมจากภาพดาวเทียม (GISTDA)",
  "legend.gistdaDepth.noneDetected": "GISTDA ไม่พบพื้นที่น้ำท่วมในจังหวัดนี้จากข้อมูลที่ดึงได้ — ไม่มีแผ่นน้ำ",
  "legend.gistdaDepth.neverFetched": "ยังดึงข้อมูล GISTDA ไม่สำเร็จ — ไม่มีแผ่นน้ำ (ไม่ได้แปลว่าไม่มีน้ำท่วม)",
  "legend.gistdaDepth.noArchivedScene": "ไม่มีข้อมูล GISTDA ที่เก็บไว้ ณ เวลาที่เลือก — ไม่มีแผ่นน้ำ (ไม่ได้แปลว่าไม่มีน้ำท่วม)",
  "legend.gistdaDepth.forecastHidden": "ซ่อนอยู่ระหว่างเลือกชั่วโมงข้างหน้าบนแถบ TMD — แผ่นนี้มาจากภาพที่ถ่ายไปแล้ว",
  "legend.gistdaDepth.dimmed": "หรี่ลง: ข้อมูล GISTDA เก่ากว่ารอบปกติ หรือแหล่งไม่ปกติ (ดูสถานะแหล่งข้อมูล)",
  ...
  "legend.layer.cctv": "กล้อง CCTV",
  "legend.layer.cctv.note":
    "แหล่ง: {sources} — หมุดสามเหลี่ยม \"เล่น\" คือวิดีโอ หมุดรูปกล้องคือภาพนิ่ง เราจะขอภาพ/สตรีมจากต้นทางก็ต่อเมื่อคลิกหมุดเท่านั้น",
  "legend.layer.cctv.video": "วิดีโอ",
  "legend.layer.cctv.still": "ภาพนิ่ง",
  "legend.layer.cctv.unverified":
    "หมุดจาง = ยังไม่ยืนยันตอนสร้างรายการ (ติดต่อไม่ได้จากเครือข่ายที่ใช้สร้าง, ตอบแต่ไม่มีภาพ/สตรีมให้ใช้ หรือไม่ได้ตรวจ) — ไม่ใช่สถานะปัจจุบัน กดดูได้",
  "legend.layer.cctv.error": "โหลดรายการกล้องของ {source} ไม่สำเร็จ ({error}) บนแผนที่จึงไม่มีหมุดของแหล่งนี้",
  "legend.layer.loadFailed": "โหลดโค้ดของชั้นนี้ไม่สำเร็จ ({error}) บนแผนที่จึงไม่มีชั้นนี้ — โหลดหน้าใหม่เพื่อลองอีกครั้ง",
  ...
  "popup.camera.fallbackName": "กล้อง {id}",
  "popup.camera.nearest": "กล้องใกล้เคียง ({km} กม.) — {source}",
  "popup.camera.open": "ดูภาพ",
  "popup.camera.owner": "กล้อง: {org}",
  "popup.camera.rights": "ภาพเป็นของเจ้าของกล้อง/แหล่งที่ระบุ ซึ่งไม่ได้รับรองหรือเกี่ยวข้องกับโครงการนี้",
  "popup.camera.unverified.unreachable":
    "ติดต่อสตรีมนี้ไม่ได้จากเครือข่าย {vantage} ตอนสร้างรายการเมื่อ {at} — บอกได้แค่ว่าถามไม่ได้จากที่นั่น ไม่ใช่ว่าต้นทางล่ม และไม่ใช่สถานะปัจจุบัน",
  "popup.camera.unverified.answered":
    "สตรีมนี้ตอบตอนสร้างรายการเมื่อ {at} จากเครือข่าย {vantage} แต่ไม่มีภาพ/สตรีมให้ใช้ ({result}) — เป็นผลตรวจครั้งนั้น ไม่ใช่สถานะปัจจุบัน",
  "popup.camera.notProbed": "สตรีมนี้ไม่ได้ถูกตรวจตอนสร้างรายการ — ยังไม่ทราบว่าตอบหรือไม่ (ไม่ใช่ล้มเหลว)",
  "popup.camera.handPlaced": "พิกัดของกล้องนี้วางโดยเรา ไม่ได้มาจากต้นทาง — ที่มาระบุในเอกสารของแหล่ง",
  "popup.camera.coLocated": "กล้องที่ตำแหน่งเดียวกัน",
  "popup.camera.streams": "สตรีมของกล้องนี้",
  "popup.camera.kindVideo": "วิดีโอ",
  "popup.camera.kindStill": "ภาพนิ่ง",
  "popup.camera.kind.dwrSnapshot": "ภาพนิ่ง",
  "popup.camera.kind.dwrMjpeg": "ดูสด",
  "popup.camera.kind.hls": "วิดีโอ",
  "popup.camera.kind.mjpeg": "ภาพสด",
  "popup.camera.kind.jpeg": "ภาพนิ่ง",
  "popup.camera.kind.jpegFetch": "ภาพนิ่ง",
  "stream.dwrSnapshot.loading": "กำลังขอภาพล่าสุดจาก DWR…",
  "stream.dwrSnapshot.alt": "ภาพล่าสุดจากกล้อง {name}",
  "stream.dwrSnapshot.takenAt": "ถ่ายเมื่อ",
  "stream.dwrSnapshot.takenAtUnknown": "ไม่ทราบ (DWR ไม่ได้ระบุเวลาในรูปแบบที่อ่านได้)",
  "stream.dwrSnapshot.fetchedAt": "ดึงภาพเมื่อ",
  "stream.dwrSnapshot.age": "อายุภาพ",
  "stream.dwrSnapshot.stale": "ภาพนี้ไม่ใช่ภาพปัจจุบัน",
  "stream.dwrSnapshot.old": "ภาพเก่ากว่า 24 ชม.",
  "stream.dwrSnapshot.unreachable":
    "ติดต่อ DWR ไม่ได้ ({detail}) เราจึงขอภาพไม่สำเร็จ และบอกอะไรเกี่ยวกับกล้องหรือพื้นที่นี้ไม่ได้",
  "stream.dwrSnapshot.noImage": "DWR ตอบกลับมาแล้ว แต่ไม่มีภาพจากกล้องนี้ ซึ่งไม่ได้บอกอะไรเกี่ยวกับสภาพพื้นที่",
  "stream.dwrSnapshot.refresh": "ขอภาพใหม่",
  "stream.dwrSnapshot.badge": "ภาพนิ่ง · ถ่าย {time}",
  "stream.dwrSnapshot.badgeNoTime": "ภาพนิ่ง · ไม่ทราบเวลาถ่าย",
  "stream.mjpeg.alt": "ภาพสดจากกล้อง {name}",
  "stream.mjpeg.connecting": "กำลังเชื่อมต่อ… (ภาพสดแบบ MJPEG ใช้เวลาราว 4–6 วินาทีกว่าจะได้เฟรมแรก)",
  "stream.mjpeg.failed":
    "ไม่ได้ภาพสดจากกล้องนี้ — ต้นทางไม่ส่งภาพ หรือเราเชื่อมต่อไม่ได้ (เบราว์เซอร์ไม่บอกว่าแบบไหน) จึงบอกอะไรเกี่ยวกับกล้องหรือพื้นที่นี้ไม่ได้",
  "stream.mjpeg.liveBadge": "สด",
  "stream.mjpeg.pausedBadge": "หยุดดูสดแล้ว",
  "stream.mjpeg.reconnectingBadge": "กำลังเชื่อมต่อใหม่…",
  "stream.mjpeg.reconnecting":
    "ไม่ได้เฟรมใหม่จากต้นทางมาสักพัก กำลังเชื่อมต่อใหม่ — ภาพที่เห็นคือเฟรมสุดท้ายที่ได้รับ ไม่ใช่ภาพสด",
  "stream.mjpeg.paused":
    "หยุดดูสดเองหลัง 5 นาที เพื่อไม่ต่อเซิร์ฟเวอร์ของต้นทางค้างไว้ — ภาพที่เห็นคือเฟรมสุดท้ายที่ได้รับ ไม่ใช่ภาพปัจจุบัน",
  "stream.mjpeg.noTime": "ภาพสด MJPEG (ต่อใหม่ทุก ~15 วินาที) — สตรีมนี้ไม่มีเวลาถ่ายกำกับ จึงไม่แสดงเวลา",
  "stream.mjpeg.resume": "ดูสดต่อ",
  "stream.mjpeg.retry": "ลองใหม่",
  "stream.hls.videoLabel": "วิดีโอจากกล้อง {name}",
  "stream.hls.loading": "กำลังเชื่อมต่อสตรีมวิดีโอ…",
  "stream.hls.suspended":
    "ต้นทางไม่มีสตรีมจากกล้องนี้ตอนนี้ ({detail}) — อาจถูกระงับชั่วคราว; ไม่ได้บอกอะไรเกี่ยวกับสภาพถนนหรือพื้นที่",
  "stream.hls.unreachable":
    "เปิดสตรีมจากเซิร์ฟเวอร์วิดีโอไม่สำเร็จ ({detail}) — เครือข่ายล้มเหลว หรือเซิร์ฟเวอร์ตอบในแบบที่เบราว์เซอร์อ่านไม่ได้ (แยกสองกรณีนี้ไม่ได้) จึงบอกอะไรเกี่ยวกับกล้องหรือพื้นที่นี้ไม่ได้",
  "stream.hls.unsupported": "เบราว์เซอร์นี้เล่นวิดีโอนี้ไม่ได้ ({detail}) — ไม่ได้บอกอะไรเกี่ยวกับกล้องหรือพื้นที่",
  "stream.hls.streamTime": "เวลาในสตรีม",
  "stream.hls.noStreamTime": "สตรีมนี้ไม่มีเวลากำกับ (ไม่มี EXT-X-PROGRAM-DATE-TIME) จึงไม่แสดงเวลาถ่าย",
  "stream.hls.retry": "ลองใหม่",
  "stream.hls.liveBadge": "สด",
  "stream.hls.bufferingBadge": "กำลังบัฟเฟอร์…",
  "stream.hls.buffering": "วิดีโอหยุดรอข้อมูลจากต้นทาง — ภาพที่ค้างอยู่ไม่ใช่ภาพสด; ไม่ได้บอกอะไรเกี่ยวกับกล้องหรือพื้นที่",
  "stream.hls.pausedBadge": "หยุดชั่วคราว",
  "stream.hls.paused": "หยุดชั่วคราว — ภาพที่ค้างอยู่ไม่ใช่ภาพสด; กดเล่นต่อจะกระโดดกลับไปที่ภาพล่าสุด",
  "stream.jpeg.alt": "ภาพนิ่งล่าสุดจากกล้อง {name}",
  "stream.jpeg.loading": "กำลังขอภาพนิ่งจากเซิร์ฟเวอร์ภาพ…",
  "stream.jpeg.detail.error": "เกิดข้อผิดพลาด",
  "stream.jpeg.detail.timeout": "หมดเวลารอ",
  "stream.jpeg.detail.rejected": "ลิงก์ภาพไม่ผ่านการตรวจ",
  "stream.jpeg.unreachable":
    "ขอภาพจากเซิร์ฟเวอร์ภาพไม่สำเร็จ ({detail}) — เครือข่ายล้มเหลว หรือต้นทางตอบกลับมาโดยไม่มีภาพ (แยกสองกรณีนี้ไม่ได้) จึงบอกอะไรเกี่ยวกับกล้องหรือพื้นที่นี้ไม่ได้; จะลองขอใหม่เรื่อย ๆ",
  "stream.jpeg.paused": "หยุดรีเฟรชอัตโนมัติแล้วหลังเปิดดู {min} นาที — ภาพที่เห็นอาจไม่ใช่ภาพล่าสุด",
  "stream.jpeg.pausedBadge": "หยุดรีเฟรชแล้ว",
  "stream.jpeg.badge": "ภาพนิ่งรีเฟรชอัตโนมัติ",
  "stream.jpeg.fetchedAt": "ได้ภาพล่าสุดเมื่อ",
  "stream.jpeg.neverFetched": "ยังไม่ได้ภาพ",
  "stream.jpeg.captureTime":
    "กล้องนี้ให้ภาพนิ่ง ไม่ใช่วิดีโอ เราขอภาพใหม่ทุก ~{s} วินาทีขณะเปิดดู — เวลาถ่าย (ถ้ามี) พิมพ์ไว้บนภาพเอง ไม่มีเป็นข้อมูลให้อ่าน เวลาด้านบนคือตอนที่เบราว์เซอร์ได้ภาพ ไม่ใช่เวลาถ่าย",
  "stream.jpeg.resume": "รีเฟรชต่อ",
  "stream.jpegFetch.alt": "ภาพนิ่งล่าสุดจากกล้อง {name}",
  "stream.jpegFetch.loading": "กำลังขอภาพนิ่งจากต้นทาง…",
  "stream.jpegFetch.unreachable":
    "ขอภาพจากต้นทางไม่สำเร็จ ({detail}) — เครือข่ายล้มเหลว หรือต้นทางไม่อนุญาตให้อ่านข้ามโดเมน จึงบอกอะไรเกี่ยวกับกล้องหรือพื้นที่นี้ไม่ได้",
  "stream.jpegFetch.noImage": "ต้นทางตอบกลับมาแล้ว แต่ไม่มีภาพจากกล้องนี้ ซึ่งไม่ได้บอกอะไรเกี่ยวกับสภาพพื้นที่",
  "stream.jpegFetch.badge": "ภาพนิ่ง · ถ่าย {time}",
  "stream.jpegFetch.badgeNoTime": "ภาพนิ่ง · ไม่ทราบเวลาถ่าย",
  "stream.jpegFetch.takenAt": "ถ่ายเมื่อ (Last-Modified ของต้นทาง)",
  "stream.jpegFetch.noTime": "ต้นทางไม่ให้เวลาถ่ายของภาพนี้ จึงไม่แสดงเวลาถ่าย (เวลาด้านล่างคือตอนที่เบราว์เซอร์ได้ภาพ)",
  "stream.jpegFetch.fetchedAt": "ดึงภาพเมื่อ",
  "stream.jpegFetch.refresh": "ขอภาพใหม่",
  "popup.status": "สถานะ",
  ...
  /** E16 B-2 — เซลล์ของแผ่นน้ำ GISTDA 3 มิติ (อยู่ในส่วน GISTDA ของ popup เสมอ) */
  "popup.gistdaDepth": "น้ำลึกประมาณ {m} ม. (ประมาณจาก DEM)",
  "popup.gistdaDepth.belowFloor": "น้ำลึก < {m} ม. — ต่ำกว่าความละเอียดของกริด ไม่ใช่ค่าวัด (ประมาณจาก DEM)",
  "popup.gistdaDepth.notEst": "ท่วม แต่ไม่ได้ประมาณความลึก (ไม่มีขอบน้ำให้อ้าง)",
  "popup.gistdaDepth.note":
    "ความลึกเป็นภาพประกอบ: FwDET จากขอบเขต GISTDA บน DEM กริด ~{m} ม. (DSM · จำนวนเต็มเมตร) — ไม่ได้วัดจริง ไม่ใช่การพยากรณ์",
