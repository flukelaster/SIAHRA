...
// Province codes and names derived from the ThaiWater/HII station geocode
// registry (Thai government source), not hand-authored.
export const PROVINCES: Province[] = [
  ...
  { code: "82", nameTh: "พังงา", nameEn: "Phangnga" },
